...
extension Model {
    ...
    static let all: [Model] = allGPT4 + allGPT35
...
extension Model {
    ...
    static let allGPT4: [Model] = [.gpt4, .gpt40314, .gpt432k, .gpt432k0314]
    
    public static let gpt4 = Model(name: "gpt-4",
    ...
    public static let gpt40314 = Model(name: "gpt-4-0314",
    ...
    public static let gpt432k = Model(name: "gpt-4-32k",
    ...
    public static let gpt432k0314 = Model(name: "gpt-4-32k-0314",
...
extension Model {
    ...
    static let allGPT35: [Model] = [.gpt35Turbo,
                                    .gpt35Turbo0301,
                                    .textDavinci003,
                                    .textDavinci002,
                                    .codeDavinci002]
    
    static let gpt35Turbo = Model(name: "gpt-3.5-turbo",
    ...
    static let gpt35Turbo0301 = Model(name: "gpt-3.5-turbo-0301",
    ...
    static let textDavinci003 = Model(name: "text-davinci-003",
    ...
    static let textDavinci002 = Model(name: "text-davinci-002",
    ...
    static let codeDavinci002 = Model(name: "code-davinci-002",
